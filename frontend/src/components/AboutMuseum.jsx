...
const AboutMuseum = () => {
  ...
  const content = {
    id: {
      ...
      titleSuffix: '?',
      description:
        'Museum bukan sekadar bangunan berisi benda-benda lama. Museum adalah institusi hidup yang menjaga ingatan kolektif, melindungi warisan budaya, dan menginspirasi generasi masa depan melalui penemuan manusia.',
      quote:
        '"Museum adalah pengelola kesadaran. Museum memberi kita cara menafsirkan sejarah, memahami dunia, dan menemukan posisi kita di dalamnya."',
      quoteAuthor: '- Hans Haacke',
      imageAlt: 'Museum Pasifika',
      features: [
        {
          icon: <History className="w-6 h-6" />,
          title: 'Menjaga Sejarah',
          description: 'Melestarikan artefak berharga serta kisah peradaban masa lampau.',
        },
        {
          icon: <BookOpen className="w-6 h-6" />,
          title: 'Ruang Edukasi',
          description: 'Lingkungan belajar interaktif yang menghidupkan ilmu di luar kelas.',
        },
        {
          icon: <Globe className="w-6 h-6" />,
          title: 'Identitas Budaya',
          description: 'Menghubungkan generasi kini dengan akar leluhur dan warisan yang beragam.',
        },
        {
          icon: <Shapes className="w-6 h-6" />,
          title: 'Seni & Sains',
          description: 'Menampilkan kreativitas, inovasi, dan pemahaman manusia tentang semesta.',
        },
      ],
    },
    en: {
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white leading-tight">
              {text.titlePrefix} <span className="text-emerald-600 dark:text-emerald-400">{text.titleHighlight}</span>{text.titleSuffix}
            </h2>
