          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              <button
                ...
                className={`h-8 px-3 rounded-lg text-xs font-bold transition-colors ${language === 'id'
              ...
              <button
                ...
                className={`h-8 px-3 rounded-lg text-xs font-bold transition-colors ${language === 'en'
                    ? 'bg-emerald-500 text-white shadow-sm'
                    : 'text-slate-600 hover:bg-white dark:text-slate-300 dark:hover:bg-slate-700'
                  }`}
              >
