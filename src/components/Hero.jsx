...
const Hero = () => {
  ...
  const text = {
    id: {
      titlePrefix: 'Jelajahi',
      titleSuffix: 'Museum Indonesia',
      description:
        'Platform untuk memetakan dan menemukan sebaran museum di seluruh nusantara. Filter berdasarkan provinsi, kategori, lalu temukan warisan budaya terdekat.',
      startExploring: 'Mulai Jelajah',
      findNearMe: 'Cari Terdekat',
      imageAlt: 'Museum Nasional',
    },
    en: {
      titlePrefix: "Explore Indonesia's",
      titleSuffix: 'Museums',
      description:
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col space-y-8 text-center lg:text-left">
          ...
          >
            {text.titlePrefix}{' '}
            <span className="museum-gradient-text">{text.titleSuffix}</span>
          </MotionH1>
